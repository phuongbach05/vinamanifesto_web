...
function spawnFallingVIcon() {
  ...
  path.setAttribute('d', 'M224.38,111.64c1.01,4.78-.88,21.72-15.71,31.24-4.77,3.06-9,4.61-12.61,4.61-.76,0-1.5-.08-2.19-.21,19.05,32.6,1.37,56.79-.11,58.72-.84,1.99-10.63,23.98-31.98,23.98-1.45,0-2.97-.1-4.54-.32-24.59-3.44-32.14-37.67-32.68-40.3-7.87-15.26-1.12-35.86,4.33-48.03-.03.02-.06.04-.09.05-10.08,5.87-22.83,10.21-33.58,12.21l-.29-1.88c10.88-2.06,24.07-6.58,34.37-12.94.38-.23.75-.47,1.12-.71,1.92-3.96,3.44-6.51,3.66-6.89l.06-.09-3.74-8.18c-2.3,1.05-8.05,4.07-11.9,9.65,3.87,1.15,5.51,2.87,5.7,3.1-.23-.12-3.51-1.72-7.85-2.15l.12-1.33c.1.02.18.04.27.05,4.07-6.45,10.09-9.82,12.93-10.97l-6.45-14.12c-1.86-4.08-3.18-6.58-3.94-7.49-1.19-1.4-2.66-2.5-4.4-3.3-1.74-.8-4.09-1.31-7.05-1.53v-2.52h39.64v2.52c-4.49.4-7.4,1.14-8.73,2.17-1.33,1.05-2,2.39-2,4.02,0,2.27,1.09,5.81,3.29,10.63l.96,2.09c3.22-2.95,5.73-4.44,6.86-5.02-.51-4.74.02-9.34,1-13.46,2.08-8.7,6.25-15.34,7.28-16.91-3.03-25.17,7.85-37.38,10.3-39.77-.52-2.53.22-6.37,2.76-9.45,1.96-2.37,6.51-5.97,14.89-3.42,3.6,1.1,6.21,3.58,7.76,7.37,3.87,9.48.7,27.37-8.72,49.04-5.88,13.55-16.62,26.45-25.98,36.04-.07,2.4-.77,10.23-6.59,16.52l14.17,31.08,10.64-24.84c-8.68-2.86-15.47-9.57-15.67-15.66-.1-3.12,1.41-7.44,9.14-10.29,3.87-1.42,7.37-1.05,10.43,1.13,1.78,1.27,3.28,3.07,4.54,5.12l3.82-8.89c2.24-5.27,3.36-8.92,3.36-10.97,0-1.32-.69-2.58-2.07-3.78-1.38-1.2-3.72-2.05-7.02-2.55-.23-.04-.64-.12-1.21-.21v-2.52h29.92v2.52c-3.44.59-6.04,1.64-7.81,3.13-2.53,2.23-4.77,5.63-6.73,10.21l-8.87,20.58c.35,1.06.67,2.12.95,3.14,2.36-1.4,6.68-2.67,9.99.26,1.26-1.66,4.49-5.22,9.88-6.67.46-1.34,1.93-4.75,5.86-7.5,1.45-1.02,2.68-1.71,3.75-2.32,2.31-1.32,3.58-2.04,4.38-4.45.32-1.01.89-1.14,1.2-1.11.88.06,1.11,1.17,1.19,1.54Z');
    ...
    if (audio.paused) {
      audio.play().then(() => {
        ...
        spawnIntervalId = setInterval(() => {
          if (Math.random() > 0.35) spawnFallingWord();
          if (Math.random() > 0.35) spawnFallingVIcon();
        }, 100);
      }).catch(err => {
